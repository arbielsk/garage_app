...
void main() {
  ...
  group('Add Vehicle Container', () {
    final _addVehicleContainer =
        MaterialWidgetWrapper(child: AddVehicleContainer());
    testWidgets('Container height 120.0 and fill the parent',
        (WidgetTester tester) async {
      final _containerSize = 120.0;
      await tester.pumpWidget(_addVehicleContainer);
      await tester.pumpAndSettle();
    ...
    testWidgets('Container padding is 8.0', (WidgetTester tester) async {
      final padding = 8.0;
      await tester.pumpWidget(_addVehicleContainer);
      await tester.pumpAndSettle();
    ...
    testWidgets('ElevatedButton text', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(_addVehicleContainer);
      await tester.pumpAndSettle();
      final addVehicleContainer = find.byType(AddVehicleContainer);

      final elevatedButton = find.descendant(
          of: addVehicleContainer, matching: find.byType(ElevatedButton));
      ...
      final textContainerSize = tester.getSize(elevatedButtonText);
      expect(textContainerSize.width + 2 *_padding, elevatedButtonSize.width);
    });
  });
}
